...
public class MarkAttendanceActivity extends AppCompatActivity {
    ...
    private boolean validateLocation(double latitude, double longitude) {
        ...
        double minLatitude = 13.0100; // Replace with actual minimum latitude
        double maxLatitude = 13.0200; // Replace with actual maximum latitude
        double minLongitude = 80.2300; // Replace with actual minimum longitude
        double maxLongitude = 80.2400; // Replace with actual maximum longitude
